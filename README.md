...
![header](https://capsule-render.vercel.app/api?type=rect&section=header&height=140&color=1F2937&text=내력%20%20內力%20Strength&fontSize=32&fontColor=FFFFFF)

</div>

<div>

## 👋 안녕하세요, 신입 백엔드 개발자 박다빈입니다
**Hi, Im DB Park! 
Thank you for viewing my github profile**

Java, Spring을 기반으로 백엔드 기능을 구현합니다.
이외에도 Cross Platform, Elasticsearch, AI Agent에 관심이 많습니다.
...
## 🧠 개발 철학
> “나무가 아닌, 숲 전체를 보기 위해 노력합니다”

- 기술 이해를 **단일 개념이 아닌, 관련 분야**로 확장합니다 
- 당장의 구현보다 **유지보수 가능한 구조**를 우선합니다.
- **장기적인 성과를 내는 협업 시스템**을 위해 고민합니다.
...
<img src="https://img.shields.io/badge/QueryDSL-3E7FC1?style=flat-square"/>
